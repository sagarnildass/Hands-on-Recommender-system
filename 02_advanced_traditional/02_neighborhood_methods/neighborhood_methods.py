...
class KNNRecommender:
    ...
    def fit(self, user_item_matrix):
        ...
        Train KNN model
        """
        print(f"Training KNN with {self.n_neighbors} neighbors using {self.metric} similarity...")
    ...
    def get_recommendations(self, user_id, n_recommendations=10):
        ...
        user_vector = self.user_item_matrix.iloc[user_idx].values.reshape(1, -1)  # Use iloc, not loc
...
class ClusteringRecommender:
    ...
    def get_recommendations(self, user_id, n_recommendations=10):
        ...
        recommendations = {}
        for cluster_user_idx in tqdm(cluster_users, desc="Processing cluster users", leave=False):
