...
class FunkSVD:
    ...
    def fit(self, ratings_matrix):
        ...
        for epoch in tqdm(range(self.n_epochs), desc="Training"):
            ...
            for idx in tqdm(range(len(ratings_values)), desc="Processing ratings", leave=False):
...
def get_matrix_factorization_recommendations(model, user_item_matrix, movies, user_id, n_recommendations=10):
    """
